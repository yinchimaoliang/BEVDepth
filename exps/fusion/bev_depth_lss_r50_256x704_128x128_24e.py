...
from datasets.nusc_mv_det_dataset import collate_fn
...
class BEVDepthLightningModel(LightningModule):
    ...
    def training_step(self, batch):
        ...
        preds, depth_preds = self(sweep_imgs, mats, lidar_depth)
    ...
    def train_dataloader(self):
        train_dataset = NuscFusionDetDataset(
    ...
    def val_dataloader(self):
        val_dataset = NuscFusionDetDataset(
            ida_aug_conf=self.ida_aug_conf,
            bda_aug_conf=self.bda_aug_conf,
            classes=self.class_names,
            data_root=self.data_root,
